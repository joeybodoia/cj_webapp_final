...
const MesaHotTubsPage = () => {
  ...
  const pageStructuredData = {
    ...
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://dsoutdoorliving.com/mesa/hot-tubs#service",
        "name": "Hot Tubs in Mesa, AZ",
        "serviceType": "Hot Tub Sales",
        "url": "https://dsoutdoorliving.com/mesa/hot-tubs",
        "provider": {
          "@type": "Store",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://dsoutdoorliving.com/mesa/hot-tubs#faq",
        "name": "Mesa Hot Tubs FAQ",
        "about": {
          "@id": "https://dsoutdoorliving.com/mesa/hot-tubs#service"
        },
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Do you have hot tubs in stock in Mesa?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. We keep a rotating selection of in-stock hot tubs that can be purchased directly. Inventory changes frequently, so call or visit our Mesa showroom page to confirm what’s available."
            }
          },
          {
            "@type": "Question",
            "name": "How fast can you deliver a hot tub in Mesa?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "Do you coordinate electrical for hot tub installation in Mesa?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. We deliver statewide across Arizona, including Mesa and surrounding East Valley communities. If you’re unsure whether you’re in our service area, call and we’ll confirm."
            }
          },
          {
            "@type": "Question",
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. Visit our Mesa showroom to compare seating layouts, jet options, and sizes in person. Call ahead to confirm availability and schedule your visit."
            }
          }
        ]
      }
  ...
  const miniFaq = [
    {
      q: 'Do you have hot tubs in stock in Mesa?',
      a: (
    ...
    {
      q: 'How fast can you deliver in Mesa?',
      a: (
        <p className="text-base md:text-lg leading-relaxed">
    ...
    },
    {
      ...
      a: (
        <p className="text-base md:text-lg leading-relaxed">
          Yes — we deliver statewide across Arizona, including Mesa and surrounding East Valley communities. Call and we’ll confirm
      ...
      <div className="pt-32 py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.35)]">
              <img
                ...
                alt="Hot tubs at D’s Outdoor Living Mesa showroom"
                loading="lazy"
                decoding="async"
            ...
            <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.35)]">
              <img
                ...
                alt="Hot tub delivery in Mesa AZ"
                loading="lazy"
                decoding="async"
                className="w-full h-72 md:h-full object-cover brightness-110"
              />
          ...
          <div className="mt-14 max-w-4xl mx-auto text-teal-100">
            <section className="bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white">
                Hot Tubs in Mesa, AZ — What to Know
              </h2>
              <p className="mt-4 text-base md:text-lg leading-relaxed">
                Buying a hot tub in Mesa is all about choosing a spa that fits Arizona living: warm weather, lots of outdoor time, and the
              ...
              <p className="mt-4 text-base md:text-lg leading-relaxed">
                ...
                the practical details that matter in the East Valley. Start by browsing our{' '}
                <a href="/hot-tubs" className="text-white underline hover:text-teal-200 transition-colors">
                  hot tub catalog
                </a>{' '}
                and then visit our{' '}
            ...
            <section className="mt-8 bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white">
                Why a Hot Tub Makes Sense in Mesa’s Climate
              </h2>
              <p className="mt-4 text-base md:text-lg leading-relaxed">
                Mesa offers extended “spa season” compared to many parts of the country. In the cooler months, hot tubs are a perfect fit
            ...
            <section className="mt-8 bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8">
              ...
              <p className="mt-4 text-base md:text-lg leading-relaxed">
                Our Mesa showroom serves buyers across the East Valley, and we also deliver statewide across Arizona. If you’re planning a showroom
                visit, start on our{' '}
                <a href="/mesa" className="text-white underline hover:text-teal-200 transition-colors">
                  Mesa location page
                </a>{' '}
            ...
            <section className="mt-8 bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8">
              ...
              <p className="mt-4 text-base md:text-lg leading-relaxed">
                Many Mesa buyers want a hot tub for a specific lifestyle outcome: family time, recovery and stress relief, or hosting friends.
          ...
          <div className="mt-14 max-w-4xl mx-auto bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white">
              Ready to Choose Your Mesa Hot Tub?
            </h2>
...
export default MesaHotTubsPage;
