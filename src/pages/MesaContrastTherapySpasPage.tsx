...
const MesaContrastTherapySpasPage = () => {
  ...
  const pageStructuredData = {
    ...
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://dsoutdoorliving.com/mesa/contrast-therapy-spas#service",
        "name": "Contrast Therapy Spas in Mesa, AZ",
        "serviceType": "Contrast Therapy Spa Sales",
        "url": "https://dsoutdoorliving.com/mesa/contrast-therapy-spas",
        "provider": {
          "@type": "Store",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://dsoutdoorliving.com/mesa/contrast-therapy-spas#faq",
        "name": "Mesa Contrast Therapy Spas FAQ",
        "about": {
          "@id": "https://dsoutdoorliving.com/mesa/contrast-therapy-spas#service"
        },
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Do you have contrast therapy spas in stock in Mesa?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "We often have a rotating selection available through our Mesa showroom. Inventory changes frequently, so call to confirm current availability and which units can be delivered fastest."
            }
          },
          {
            "@type": "Question",
            "name": "How fast can you deliver a contrast therapy spa in Mesa?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "Do you deliver outside Mesa?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. We deliver statewide across Arizona, including Mesa and the East Valley. Call to confirm logistics and timelines for your address."
            }
          },
          {
            "@type": "Question",
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. Units include manufacturer warranties that vary by model and brand. Financing options are also available—contact our Mesa showroom for current programs and details."
            }
          },
          {
            "@type": "Question",
            "name": "Can I see contrast therapy spas in person at the Mesa showroom?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. Visit our Mesa showroom to compare options and plan your setup. Call ahead to confirm hours, availability, and the best time to stop by."
            }
          }
        ]
      }
  ...
  const miniFaq = [
    {
      q: 'Do you have contrast therapy spas in stock in Mesa?',
      a: (
    ...
    {
      q: 'How fast can you deliver in Mesa / the East Valley?',
      a: (
        <p className="text-base md:text-lg leading-relaxed">
      ...
      <div className="pt-32 py-16">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white text-center">
            Contrast Therapy Spas in Mesa, AZ
          </h1>
          ...
          <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
              ...
              <p className="mt-2 text-teal-100 text-sm md:text-base">
                We deliver across AZ, including Mesa and the East Valley.
              </p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
          ...
          <div className="mt-12 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.35)]">
              <img
                ...
                alt="Contrast therapy spas at D’s Outdoor Living Mesa showroom"
                loading="lazy"
                decoding="async"
            ...
            <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.35)]">
              <img
                ...
                alt="Contrast therapy spa delivery in Mesa AZ"
                loading="lazy"
                decoding="async"
                className="w-full h-72 md:h-full object-cover brightness-110"
              />
          ...
          <div className="mt-14 max-w-4xl mx-auto text-teal-100">
            <section className="bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white">
                Contrast Therapy Spas in Mesa, AZ — What to Know
              </h2>
              <p className="mt-4 text-base md:text-lg leading-relaxed">
                Contrast therapy combines heat exposure (hot spa) with cold exposure (cold plunge) in a repeatable routine. In Mesa and the West
              ...
              <p className="mt-4 text-base md:text-lg leading-relaxed">
                ...
                or{' '}
                <a href="/mesa/swim-spas" className="text-white underline hover:text-teal-200 transition-colors">
                  Mesa swim spas
                </a>{' '}
            ...
            <section className="mt-8 bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8">
              <h2 className="text-2xl md:text-3xl font-bold text-white">
                Why Contrast Therapy Fits the East Valley Lifestyle
              </h2>
              <p className="mt-4 text-base md:text-lg leading-relaxed">
                Mesa is built around active living — neighborhood gyms, weekend sports, golf, hiking, and year-round outdoor time. A contrast
            ...
            <section className="mt-8 bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8">
              ...
              <p className="mt-4 text-base md:text-lg leading-relaxed">
                Our Mesa showroom supports buyers across the East Valley — and we also deliver statewide across Arizona. For showroom details and
                NAP info, visit our{' '}
                <a href="/mesa" className="text-white underline hover:text-teal-200 transition-colors">
                  Mesa location page
                </a>
          ...
          <div className="mt-14 max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-white text-center">
              Mesa Contrast Therapy — Quick Answers
            </h2>
            <p className="mt-3 text-center text-teal-100 text-base md:text-lg">
              Common questions about inventory, delivery, and setup in Mesa / the East Valley.
            </p>
          ...
          <div className="mt-14 max-w-4xl mx-auto bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white">
              Ready to Build Your Mesa Contrast Therapy Setup?
            </h2>
...
export default MesaContrastTherapySpasPage;
